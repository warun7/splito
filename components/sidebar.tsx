...
export function Sidebar() {
  ...
  return (
    <>
      {isOpen && (
        <div
          className="fixed inset-0 bg-black/60 backdrop-blur-sm min-[1025px]:hidden z-50"
          onClick={close}
        />
      )}
      ...
      >
        <div className="flex h-full flex-col">
          {/* Logo/Brand Section */}
          <div className="flex h-[80px] items-center px-6 mt-4 relative">
          ...
          <div className="flex-1 space-y-1 px-4 py-6">
            <Link
              ...
              onClick={close}
              className={cn(
                "flex h-[50px] items-center gap-3.5 rounded-xl px-4 text-[15px] font-medium transition-all",
                pathname === "/"
          ...
          <div className="p-4 mt-auto">
            ...
            >
              ...
              <span className="text-sm font-medium ml-1">Follow us</span>
            </a>
          </div>
        </div>
      </div>
